...
HD_PWD='C:/Users/SET253-15U.HCCMAIN/Documents/GitHub/ENES246/1Wires/Vivado_RTL/buffers.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log switchLED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source switchLED.tcl
