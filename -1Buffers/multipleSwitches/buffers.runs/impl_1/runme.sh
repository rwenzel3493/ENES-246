...
HD_PWD='C:/Users/SET253-15U.HCCMAIN/Documents/GitHub/ENES246/1Wires/Vivado_RTL/buffers.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log switchLED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source switchLED.tcl -notrace
