...
HD_PWD='D:/ENES246-master/ENES246-master/-1Buffers/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_1.tcl -notrace
