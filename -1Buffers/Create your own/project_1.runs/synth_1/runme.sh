...
HD_PWD='D:/ENES246-master/ENES246-master/-1Buffers/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_1.tcl
