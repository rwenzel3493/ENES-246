...
HD_PWD='D:/GitHub/ENES-246/10Latches/4_EveryOtherAsynchronousSequential/everyOther.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log everyOther.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source everyOther.tcl
