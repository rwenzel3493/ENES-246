...
HD_PWD='D:/GitHub/ENES-246/10Latches/6_WobblyRingDelays/WobblyRing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wobblyRing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wobblyRing.tcl
