...
HD_PWD='D:/GitHub/ENES-246/10Latches/6_WobblyRingDelays/WobblyRing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wobblyRing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wobblyRing.tcl -notrace
