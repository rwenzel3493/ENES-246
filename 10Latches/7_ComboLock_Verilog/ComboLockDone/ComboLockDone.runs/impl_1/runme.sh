...
HD_PWD='D:/GitHub/ENES-246/10Latches/7_ComboLock_Verilog/ComboLockDone/ComboLockDone.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comboLockDone.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comboLockDone.tcl -notrace
