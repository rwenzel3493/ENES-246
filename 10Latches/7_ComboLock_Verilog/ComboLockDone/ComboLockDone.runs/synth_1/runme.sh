...
HD_PWD='D:/GitHub/ENES-246/10Latches/7_ComboLock_Verilog/ComboLockDone/ComboLockDone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comboLockDone.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comboLockDone.tcl
