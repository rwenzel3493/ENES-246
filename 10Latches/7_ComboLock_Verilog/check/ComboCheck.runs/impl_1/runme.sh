...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/10Latches/5_ComboLock/ComboCheck.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CombCheck.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CombCheck.tcl -notrace
