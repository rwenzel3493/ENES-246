...
HD_PWD='D:/GitHub/ENES-246/-3AndNand/DoItYourself/DoItYourslef/DoItYourslef.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NandXor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NandXor.tcl
