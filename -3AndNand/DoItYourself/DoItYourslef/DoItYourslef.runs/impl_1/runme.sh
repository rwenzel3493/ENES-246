...
HD_PWD='D:/GitHub/ENES-246/-3AndNand/DoItYourself/DoItYourslef/DoItYourslef.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NandXor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NandXor.tcl -notrace
