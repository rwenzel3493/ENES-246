...
HD_PWD='D:/GitHub/ENES-246/-8SevenSegDisplays/3_d7SegDisplay/d7segDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d7segDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source d7segDisplay.tcl
