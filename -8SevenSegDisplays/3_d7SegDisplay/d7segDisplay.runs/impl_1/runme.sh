...
HD_PWD='D:/GitHub/ENES-246/-8SevenSegDisplays/3_d7SegDisplay/d7segDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log d7segDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source d7segDisplay.tcl -notrace
