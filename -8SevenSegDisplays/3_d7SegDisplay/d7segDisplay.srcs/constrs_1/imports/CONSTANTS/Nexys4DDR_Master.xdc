...
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { inDecimalPlace }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { anode }]; #IO_L7N_T1_D10_14 Sch=sw[5]
...
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { outDecimalPlace }]; #IO_L19N_T3_A21_VREF_15 Sch=dp
