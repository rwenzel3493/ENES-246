...
HD_PWD='D:/Vivado_Labs/User_Demo/proj/User_Demo.runs/ddr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr.tcl
