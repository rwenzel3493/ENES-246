...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/11IP/2_Square_Root_IP/SquareRootIP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SquareRoot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SquareRoot.tcl
