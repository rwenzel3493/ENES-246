...
HD_PWD='D:/GitHub/ENES-246/-6TestingTruthTables/2dec-mux-nothing/dec-mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoderToMuxTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoderToMuxTest.tcl
