...
HD_PWD='D:/GitHub/ENES-246/-6TestingTruthTables/2dec-mux-nothing/dec-mux.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log decoderToMuxTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoderToMuxTest.tcl -notrace
