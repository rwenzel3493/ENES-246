...
HD_PWD='D:/GitHub/ENES-246/-5MuxOfMux/m4x2Mux/m4x2Mux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log m4x2Mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source m4x2Mux.tcl -notrace
