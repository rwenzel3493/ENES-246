...
HD_PWD='D:/GitHub/ENES-246/-5MuxOfMux/m16x4MuxRTL/m16x4Mux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log m16x4Mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source m16x4Mux.tcl -notrace
