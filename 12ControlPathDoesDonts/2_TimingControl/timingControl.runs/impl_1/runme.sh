...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/12ControlPathDoesDonts/2_TimingControl/timingControl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log always_example.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source always_example.tcl -notrace
