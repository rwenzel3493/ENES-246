...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/12ControlPathDoesDonts/1_MultipleAssignComb/MultipleAssignCombo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MultipleAssignCombo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MultipleAssignCombo.tcl
