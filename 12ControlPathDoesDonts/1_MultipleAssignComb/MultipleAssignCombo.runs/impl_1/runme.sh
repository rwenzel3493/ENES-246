...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/12ControlPathDoesDonts/1_MultipleAssignComb/MultipleAssignCombo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MultipleAssignCombo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MultipleAssignCombo.tcl -notrace
