...
#set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { slowFast }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
...
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { asyncReset }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
