...
HD_PWD='C:/Users/SET253-24U.HCCMAIN/Documents/GitHub/ENES246/12ControlPathDoesDonts/2_Growth/growth/growth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log always_comb_example.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source always_comb_example.tcl
