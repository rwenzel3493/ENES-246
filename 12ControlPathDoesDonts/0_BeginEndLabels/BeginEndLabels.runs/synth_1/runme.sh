...
HD_PWD='C:/Users/SET253-17U.HCCMAIN/Documents/GitHub/ENES246/12ControlPathDoesDonts/3_BeginEndLabels/BeginEndLabels.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log always_comb_mux_example.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source always_comb_mux_example.tcl
