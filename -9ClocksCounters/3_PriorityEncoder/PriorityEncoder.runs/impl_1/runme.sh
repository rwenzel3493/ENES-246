...
HD_PWD='D:/GitHub/ENES-246/-9ClocksCounters/3_PriorityEncoder/PriorityEncoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PriorityEncoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PriorityEncoder.tcl -notrace
