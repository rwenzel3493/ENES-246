...
HD_PWD='D:/GitHub/ENES-246/-9ClocksCounters/3_PriorityEncoder/PriorityEncoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PriorityEncoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PriorityEncoder.tcl
