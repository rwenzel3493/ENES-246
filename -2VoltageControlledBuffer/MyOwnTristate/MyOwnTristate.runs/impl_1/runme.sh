...
HD_PWD='D:/GitHub/ENES-246/BufferVoltageControll/MyOwnTristate/MyOwnTristate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Tri.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Tri.tcl -notrace
