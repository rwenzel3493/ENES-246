...
HD_PWD='D:/GitHub/ENES-246/BufferVoltageControll/MyOwnTristate/MyOwnTristate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Tri.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Tri.tcl
